...
export type ProductTypeWhereInput = {
  ...
  typeId?: Prisma.IntFilter<"ProductType"> | number
...
export type ProductTypeScalarWhereWithAggregatesInput = {
  ...
  typeId?: Prisma.IntWithAggregatesFilter<"ProductType"> | number
...
export type ProductTypeOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"typeId" | "name", ExtArgs["result"]["productType"]>
...
export interface ProductTypeDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const productTypeWithTypeIdOnly = await prisma.productType.findMany({ select: { typeId: true } })
   * 
   */
...
export interface ProductTypeFieldRefs {
  readonly typeId: Prisma.FieldRef<"ProductType", 'Int'>
